...
static void nicola_alnum_tap(uint16_t keycode) {
  tap_code16(KC_CAPS);
  tap_code16(keycode);
  tap_code16(KC_CAPS);
}
...
void nicola_m_type(void) {
    switch(nicola_m_key) {
        ...
        case NG_P   : nicola_alnum_tap(KC_COMM); break; // ，
        case NG_LBRC: send_string("," ); break;
        case NG_RBRC: send_string(";" ); break;
        case NG_BSLS: nicola_alnum_tap(KC_INT1); break;
        ...
        case NG_QUOT: tap_code16(KC_BSPC); break;

        case NG_Z   : nicola_alnum_tap(KC_DOT); break; // ，
...
void nicola_om_type(void) {
    if(nicola_o_key == NG_SHFTL) {
        switch(nicola_m_key) {
            case NG_1   : nicola_alnum_tap(S(KC_SLSH)); break;
            case NG_2   : nicola_alnum_tap(KC_SLSH); break;
            case NG_3   : nicola_alnum_tap(S(KC_EQL)); break; // ~
            case NG_4   : send_string("]" ); break; // [
            case NG_5   : tap_code16(KC_NUHS); break; // ]
            case NG_6   : send_string(SS_LSFT("]" )); break; // {
            case NG_7   : tap_code16(S(KC_NUHS)); break; // }
            case NG_8   : tap_code16(S(KC_QUOT)); break; // *
            case NG_9   : send_string("*" ); break; // (
            case NG_0   : send_string("(" ); break; // )
            case NG_MINS: tap_code16(S(KC_INT1)); break; // _
            case NG_EQL : send_string(SS_LSFT(";")); break; // +
            ...
            case NG_LBRC: send_string("]" ); break;
            case NG_RBRC: tap_code16(KC_NUHS); break;
            case NG_BSLS: nicola_alnum_tap(KC_INT1); break;
