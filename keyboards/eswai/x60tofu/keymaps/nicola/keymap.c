...
//            ,         ,         ,        ,        ,        ,        ,        ,        ,        ,        ,        ,        ,        ,        ,
	  	KC_GRV  ,KC_1     ,KC_2    ,KC_3    ,KC_4    ,KC_5    ,KC_6    ,KC_7    ,KC_8    ,KC_9    ,KC_0    ,KC_MINS ,KC_EQL  ,KC_BSPC ,KC_DEL  , \
		  KC_TAB  ,KC_Q     ,KC_W    ,KC_E    ,KC_R    ,KC_T    ,KC_Y    ,KC_U   ,KC_I    ,KC_U    ,KC_P    ,KC_QUOT ,KC_BSLS , \
CMD_T(KC_ESC) ,KC_A     ,KC_S    ,KC_D    ,KC_F    ,KC_G    ,KC_H    ,KC_J    ,KC_K    ,KC_L    ,KC_SCLN ,KC_QUOT ,KC_ENT  , \
      KC_LSFT ,KC_Z     ,KC_X    ,KC_C    ,KC_V    ,KC_B    ,KC_N    ,KC_M    ,KC_COMM ,KC_DOT  ,KC_SLSH ,KC_HOME ,KC_UP   ,KC_END, \
...
//            ,         ,        ,        ,        ,        ,        ,        ,        ,        ,        ,        ,        ,        ,        ,
   ...
   LWIN(KC_E) ,XXXXXXX  ,KC_LBRC ,KC_LCBR ,KC_LPRN ,KC_LT   ,KC_ASTR ,KC_4    ,KC_5    ,KC_6    ,KC_PLUS ,XXXXXXX ,XXXXXXX , \
      XXXXXXX ,XXXXXXX  ,KC_RBRC ,KC_RCBR ,KC_RPRN ,KC_GT   ,KC_0    ,KC_1    ,KC_2    ,KC_3    ,KC_EQL  ,XXXXXXX ,KC_PGUP ,XXXXXXX , \
		  _______ ,_______  ,_______          ,KC_EISU          ,KC_KANA2         ,_______           ,_______ ,KC_HOME ,KC_PGDN ,KC_END
  ),
...
//            ,         ,        ,        ,        ,        ,        ,        ,        ,        ,        ,        ,        ,        ,        ,
      ...
      XXXXXXX ,KC_GRV   ,KC_PIPE ,KC_EXLM ,KC_UNDS ,LALT(KC_INT3),XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX ,KC_PGUP ,XXXXXXX , \
	    _______ ,_______   ,_______          ,KC_EISU          ,KC_KANA2         ,_______          ,_______ ,XXXXXXX ,KC_PGDN ,XXXXXXX
  ),
...
//            ,         ,        ,        ,        ,        ,        ,        ,        ,        ,        ,        ,        ,        ,        ,
  ...
  [_NICOLA] = LAYOUT(
//            ,         ,        ,        ,        ,        ,        ,        ,        ,        ,        ,        ,        ,        ,        ,
	    _______ ,NG_1     ,NG_2    ,NG_3    ,NG_4    ,NG_5    ,NG_6    ,NG_7    ,NG_8    ,NG_9    ,NG_0    ,NG_MINS ,NG_EQL,_______ ,_______ , \
		  _______ ,NG_Q     ,NG_W    ,NG_E    ,NG_R    ,NG_T    ,NG_Y    ,NG_U    ,NG_I    ,NG_O    ,NG_P    ,NG_LBRC ,NG_RBRC , \
      _______ ,NG_A     ,NG_S    ,NG_D    ,NG_F    ,NG_G    ,NG_H    ,NG_J    ,NG_K    ,NG_L    ,NG_SCLN ,NG_QUOT ,_______ , \
		  ...
		  _______ ,_______  ,_______          ,NG_SHFTL          ,NG_SHFTR         ,_______          ,_______ ,_______ ,_______ ,_______
  ),
